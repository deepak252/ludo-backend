...
//     // await redisClient.hdel(`user:${match.players.green.username}`, 'room')
//     // await redisClient.hdel(`user:${match.players.yellow.username}`, 'room')
//     // await redisClient.hdel(`user:${match.players.blue.username}`, 'room')
//     // await redisClient.hdel(`user:${match.players.red.username}`, 'room')
//   }
